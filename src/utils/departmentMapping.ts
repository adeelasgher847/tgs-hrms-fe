...
export const getDepartmentByDesignationId = (
  designationId: string
): BackendDepartment | null => {
...
export const getDepartmentByDesignationTitle = (
  designationTitle: string
): BackendDepartment | null => {
  const designation = designationCache.find(
    d => d.title.toLowerCase() === designationTitle.toLowerCase()
  );
  if (!designation) return null;
