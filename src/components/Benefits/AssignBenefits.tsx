...
export default function AssignBenefits({
  ...
  useEffect(() => {
    listBenefits({ page: 1, pageSize: 100 }).then(res =>
      setBenefits(res.items)
    );
  }, []);
    ...
    try {
      if (!selectedBenefitIds.length || !startDate) {
        ...
        window.dispatchEvent(
          new CustomEvent('benefitsAssigned', {
            detail: {
            ...
            <Stack spacing={2}>
              ...
              <FormControl fullWidth>
                ...
                <Select
                  ...
                  onChange={e =>
                    setSelectedBenefitIds(e.target.value as string[])
                  }
