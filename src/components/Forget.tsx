    ...
    return (
        <Box className="login-scroll" sx={{ minHeight: '100vh', height: '100vh', m: { xs: '30px', sm: 0 }, position: 'relative' }}>
            ...
            >
                ...
                <Box sx={{ alignItems: 'center', flex: 1, width: { xs: '100%', lg: '700px' }, mx: 'auto', height: '100vh' }}>
                    <Paper
                        elevation={4}
                        sx={{
                    ...
                    >
                        ...
                        <Box sx={{ textAlign: 'center', mb: { xs: 1, sm: 6 }, }}>
                            ...
                            <Typography sx={{ fontSize: '14px', fontFamily: 'Open Sans, sans-serif' }}>
                                {lang === 'ar' ? 'وصول مجاني إلى لوحة التحكم الخاصة بنا.' : 'Enter the email address you used when you joined and we shall send you instructions to reset your password.'}
                            </Typography>
                        </Box>
